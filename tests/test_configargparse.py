...
try:
    ...
    logging.error("\n\n" + ("=" * 80) + "\n"
        "WARNING: Unable to import test.test_argparse, so argparse tests will "
        "be skipped. \nA solution may be to install python from source and make "
        "sure the test dir is on your PYTHONPATH.\n"
        + ("=" * 80) + "\n")
else:
